...
//
//            StringEntity httpEntity = new StringEntity(requestBody.toString(), Charset.forName("UTF-8"));
//            RequestBuilder builder = RequestBuilder.post(requestUrl)
//                    .setHeader(HttpHeaders.CONTENT_TYPE, "application/json").setEntity(httpEntity);
//            HttpResponse response = zosmfconnector.request(builder);
//            if (ResponseUtils.getStatus(response) == HttpStatus.SC_CREATED) {
//                return dataSetName;
//            }
