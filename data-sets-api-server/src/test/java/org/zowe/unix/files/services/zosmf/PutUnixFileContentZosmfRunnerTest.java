...
public class PutUnixFileContentZosmfRunnerTest extends AbstractZosmfRequestRunnerTest {
    ...
    public void put_unix_file_with_unauthorised_file_throws_correct_error() throws Exception {
        ...
        putContentTestWithException(path, exception, HttpStatus.SC_INTERNAL_SERVER_ERROR, "getUnixFileContentUnauthorised.json");
    }
    ...
    private void putContentTestWithException(String path, Exception exception, int returnCode, String testFile) throws Exception {
        UnixFileContent content = new UnixFileContent("hello world");
