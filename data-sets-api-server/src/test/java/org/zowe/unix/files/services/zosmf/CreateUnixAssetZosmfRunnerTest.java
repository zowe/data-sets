...
public class CreateUnixAssetZosmfRunnerTest extends AbstractZosmfRequestRunnerTest {
    ...
    private void creatUnixAssetSuccessTest(String path, UnixCreateAssetRequest createAssetRequest, String zosmfJsonString) throws Exception {      
    ...
    @Test
    public void create_unix_asset_with_conflicting_assets_already_existing_and_throw_already_exists_error() throws Exception {
